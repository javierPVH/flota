"""Seed de desarrollo: espacio de erratas, N7 (destructivo — ver back/SEED_DEV.md).

Ejecutable suelto: `python manage.py reset_erratas`. También corre en la cadena de
...
class Command(BaseCommand):
    help = "Seed de desarrollo: espacio de erratas (registros desactivados N7) (borra y recrea)."
    ...
    def handle(self, *args, **kwargs):
        ...
        seed.seed_erratas(self.stdout)
        self.stdout.write(self.style.SUCCESS("Seed [erratas] OK."))
