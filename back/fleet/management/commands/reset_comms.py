"""Seed de desarrollo: comunicaciones (EmailLog N10 y push N9) (destructivo — ver back/SEED_DEV.md).

Ejecutable suelto: `python manage.py reset_comms`. También corre en la cadena de
...
class Command(BaseCommand):
    help = "Seed de desarrollo: comunicaciones (EmailLog N10 y push N9) (borra y recrea)."
    ...
    def handle(self, *args, **kwargs):
        ...
        seed.seed_comms(self.stdout)
        self.stdout.write(self.style.SUCCESS("Seed [comms] OK."))
