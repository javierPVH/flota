...
const es = {
  ...
  /** GAP-2: KPI del consumo medio (última anotación del ordenador de a bordo). */
  fuelAvgTitle: 'Consumo medio',
  fuelAvgHint: 'Anotar el consumo medio que marca el ordenador de a bordo',
  fuelAvgNone: 'Sin anotaciones',
  fuelAvgSub: (date: string) => `Anotado el ${date}`,
  ...
  returnDoneLinks: 'Sustituciones cerradas',
  returnDoneAlerts: 'Alertas resueltas',
...
const en: typeof es = {
  ...
  fuelAvgTitle: 'Average consumption',
  fuelAvgHint: 'Note the average consumption shown by the on-board computer',
  fuelAvgNone: 'No entries',
  fuelAvgSub: (date) => `Noted on ${date}`,
  ...
  returnDoneLinks: 'Substitutions closed',
  returnDoneAlerts: 'Alerts resolved',
