...
const es = {
  ...
  /** GAP-2: div informativo del gasto de combustible del mes en curso. */
  fuelMonthTitle: 'Combustible (mes)',
  fuelMonthHint: 'Registrar el gasto de combustible del mes',
  fuelMonthNone: 'Sin gasto este mes',
  fuelMonthNoAmount: 'Sin importe registrado',
...
const en: typeof es = {
  ...
  fuelMonthTitle: 'Fuel (month)',
  fuelMonthHint: "Log this month's fuel spend",
  fuelMonthNone: 'No spend this month',
  fuelMonthNoAmount: 'No amount logged',
